...
* **tflint:** 🐛 bump Azure rules version, fix signature bug e97e2e1

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 5988378
* **deps:** update dependency opentofu to v1.12.2 b781cde
* **deps:** update dependency opentofu to v1.12.3 8bb42dc
* **deps:** update dependency opentofu to v1.12.4 a0c4f72
* **deps:** update dependency tflint to v0.63.1 701653a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 c9f5651
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 f9f33b2

## 8.8.5 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 477b2ab

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu f6c6437
* **deps:** update dependency opentofu to v1.11.7 5db77e2
* **deps:** update dependency opentofu to v1.12.0 68842f5
* **deps:** update dependency terraform-docs to v0.23.0 7b8c548
* **deps:** update dependency terraform-docs to v0.24.0 9b7c6dd
* **deps:** update dependency tflint to v0.62.1 ed8dc8b
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 92d3ffb
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 31c00d5
* **deps:** update tools c45be92
* **pre-commit:** 🔧 move to prek e525ad2
* **tfdocs:** bump tfdocs to v0.22 🔧 2798a44
...
* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 842b149

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.11.2 c2c5b0b
* **deps:** update dependency opentofu to v1.11.3 89c8c5a
* **deps:** update dependency opentofu to v1.11.4 6cbf4ba
* **deps:** update dependency opentofu to v1.11.5 9226ba0
* **deps:** update dependency pre-commit to v4.4.0 c5d202a
* **deps:** update dependency pre-commit to v4.5.0 3497e3d
* **deps:** update dependency pre-commit to v4.5.1 75175c6
* **deps:** update dependency tflint to v0.60.0 2f41b07
* **deps:** update dependency tflint to v0.61.0 38784c1
* **deps:** update dependency trivy to v0.68.1 3ff69bc
* **deps:** update dependency trivy to v0.68.2 b7641c3
* **deps:** update dependency trivy to v0.69.0 632d1f2
* **deps:** update dependency trivy to v0.69.1 c401484
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 f0236de
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 7001260
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 e7f5323
* **deps:** update tools d6cd4fe
