output "linux_function_app" {
  ...
  value = lower(var.os_type) == "linux" ? {
    ...
    storage_account_primary_connection_string   = local.storage_account_output.primary_connection_string
    storage_account_primary_access_key          = local.storage_account_output.primary_access_key
    storage_account_secondary_connection_string = local.storage_account_output.secondary_connection_string
    storage_account_secondary_access_key        = local.storage_account_output.secondary_access_key
