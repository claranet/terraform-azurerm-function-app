...
output "function_app_default_hostname" {
  ...
  value       = azurerm_windows_function_app.windows_function.default_hostname
}
...
output "function_app_slot_name" {
  ...
  value       = try(azurerm_windows_function_app_slot.windows_function_slot[0].name, null)
}

output "function_app_slot_default_hostname" {
  description = "Default hostname of the Function App slot"
  value       = try(azurerm_windows_function_app_slot.windows_function_slot[0].default_hostname, null)
}

output "function_app_slot_identity" {
  description = "Identity block output of the Function App slot"
  value       = try(azurerm_windows_function_app_slot.windows_function_slot[0].identity[0], null)
}
