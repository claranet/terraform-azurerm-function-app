...
# Flex-specific variables (for future support)
variable "runtime_name" {
  description = "The runtime name for the Function App slot. Only affects Flex Consumption slots when supported."
  type        = string
  default     = null
}

variable "runtime_version" {
  description = "The runtime version for the Function App slot. Only affects Flex Consumption slots when supported."
  type        = string
  default     = null
}

variable "maximum_instance_count" {
  description = "The maximum number of instances for this Function App slot. Only affects Flex Consumption slots when supported."
  type        = number
  default     = null
}

variable "instance_memory_mb" {
  description = "The amount of memory in megabytes allocated to each instance of the Function App slot. Only affects Flex Consumption slots when supported."
  type        = number
  default     = null
}

variable "always_ready_functions" {
  description = "Set the number of always-ready instances for each function in your app slot. Only affects Flex Consumption slots when supported."
  type = list(object({
    name           = string
