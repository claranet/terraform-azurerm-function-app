variable "os_type" {
  description = "OS type for the Functions to be hosted in the Service Plan. Possible values include `Windows`, `Linux`, `WindowsContainer`."
  type        = string
}

variable "sku_name" {
  description = "The SKU for the Service Plan. Possible values include B1, B2, B3, D1, F1, FC1, I1, I2, I3, I1v2, I2v2, I3v2, P1v2, P2v2, P3v2, P1v3, P2v3, P3v3, P1mv3, P2mv3, P3mv3, P4mv3, P5mv3, S1, S2, S3, SHARED, EP1, EP2, EP3, WS1, WS2, WS3, and Y1."
  type        = string
  default     = "Y1"
}
